...
f = open("emails.txt", "a")
strs = """Email:enquiry@alliance.edu.in   Helpline: +91 80 3093 8100 / 8200 / 4619 9100
...
"""
# email = re.findall(r"[0-9a-zA-Z._+%]+@[0-9a-zA-Z._+%]+[.][a-zA-Z.0-9]+", strs)
email = re.findall(r"\w+@\S+\w+", strs)
print(email)
emails = str(email)
f.write(emails)
